...
public class Student {
	    ...
	    public Student(Name name, Subject kor) {
	       this(name, kor ,new Subject(),new Subject());
	    }
	   
	    public Student(Name name, Subject kor, Subject mat) {
	       this(name, kor ,mat,new Subject());
	    }
	 
	    public Student(Name name, Subject kor,Subject mat,Subject eng) {
	        this.name = name;
	        this.kor = kor;
	        this.eng = eng;
	        this.mat = mat;
