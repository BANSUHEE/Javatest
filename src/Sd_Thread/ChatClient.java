...
// 데이터베이스 연결 생성자
   ...
   private void openSignupWindow() {
      ...
      // 패널 별로 입력하고 엔터로 이동하도록 ActionListener 추가
      newidField.addActionListener(new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
              newPasswordField.requestFocusInWindow(); // 패스워드 필드로 포커스 이동
          }
      });
      ...
      newPasswordField.addActionListener(new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
              newNameField.requestFocusInWindow(); // 이름 필드로 포커스 이동
          }
      });
      ...
      newNameField.addActionListener(new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
              newPhoneField.requestFocusInWindow(); // 전화번호 필드로 포커스 이동
          }
      });

      newPhoneField.addActionListener(new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
              createButton.doClick(); // "Create" 버튼 클릭
          }
      });
