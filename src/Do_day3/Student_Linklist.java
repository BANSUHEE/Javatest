...
import java.util.*;
	...
	//-------------------------------여기는 Set입니당 ----------------------------------
	public class Student_Linklist implements ProgramFunction2 {
		Scanner sc = new Scanner(System.in);
		Set<StudentScoreHasA2> st;
		StudentScoreHasA2 pointer;
		
	// Constructor
	// 모든 학생을 관리할 수 있는 객체 생성시, 모든학생들을 담을 stuArray를 생성한다.
	// 매개변수 생성자는 허용되지않는다.
		public Student_Linklist() {
			 st = new HashSet<StudentScoreHasA2>();
		}
		...
		public void addData() {
			...
			StudentScoreHasA2 stu = new StudentScoreHasA2();
...
//		Scanner sc = new Scanner(System.in);
//		Map<Integer,StudentScoreHasA> st;
//		int key = 0;
//		int idx = 0;
	//	
	//// Constructor
...
//			stu.setEng(sc.nextInt());
//			stu.setMat(sc.nextInt());
//			st.put(key++,stu); //key를 자동으로 박싱하여  Integer로 넣어줌.
//			
//		}
	//
//		@Override
